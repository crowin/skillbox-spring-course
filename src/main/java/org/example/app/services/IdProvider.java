...
public class IdProvider implements InitializingBean, DisposableBean, BeanPostProcessor {
    ...
    private void defaultInit() {
        logger.info("default provider Init in IdProvider bean");

    }

    private void defaultDestroy() {
        logger.info("default provider Destroy in dProvider bean");
    }

    @Override
    public void destroy() throws Exception {
        logger.info("DisposibleBean destroy");

    }

    @Override
    public void afterPropertiesSet() throws Exception {
        logger.info("provider PropertiesSet");
    }
